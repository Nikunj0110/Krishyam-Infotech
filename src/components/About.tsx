      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed">
            We started Krishyam Infotech because we saw one big problem —
            ...
            <br /><br /> */}
            At Krishyam, every pixel has a purpose, every line of code has a meaning, and every project has a soul.
          </p>
        </div>
        ...
        {/* <div className="mb-12">
          ...
          <div className="max-w-4xl mx-auto text-gray-700 text-base leading-relaxed space-y-4">
            <p>
              We started Krishyam Infotech with one simple belief:
            </p>
            ...
            <p>
              Krishyam Infotech is our promise to do meaningful work, to respect every client’s vision, and to deliver solutions that elevate brands and empower people.
            </p>
